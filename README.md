...
<div style="text-align: center;">
    <img src="images/sched.png" alt="Sched">
    <br>
    <small><i>Here is a schedule generated by QuickSched.</i></small>
</div>
...
<div style="text-align: center;">
    <img src="images/task.png" alt="Sched">
    <br>
    <small><i>Examples using the 'task' command.</i></small>
</div>
...
```
<div style="text-align: center;">
    <img src="images/card.png" alt="Sched">
    <br>
    <small><i>Examples using the 'card' command.</i></small>
</div>
...
```
<div style="text-align: center;">
    <img src="images/event.png" alt="Sched">
    <br>
    <small><i>Examples using the 'event' command.</i></small>
</div>
...
<div style="text-align: center;">
    <img src="images/sched.png" alt="Sched">
    <br>
    <small><i>Example using the 'sched' command.</i></small>
</div>
...
This command tells QuickSched to both schedule/timetable all your scheduling data as well as generate a table for you to view.
<div style="text-align: center;">
    <img src="images/subtask.png" alt="Sched">
    <br>
    <small><i>Example using the 'subtask' command.</i></small>
</div>
...
<div style="text-align: center;">
    <img src="images/log.png" alt="Sched">
    <br>
    <small><i>Example using the 'log' command.</i></small>
</div>
...
<div style="text-align: center;">
    <img src="images/config.png" alt="Sched">
    <br>
    <small><i>Example using the 'config' command.</i></small>
</div>
